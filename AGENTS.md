...
- Phase 01 완료와 Phase 02 디자인 시스템 검수 단계
...
- PROJECTS의 기존 상태 보존과 최소 공개 속성 추가 계약
...
- 장편 영상의 YouTube 공개·일부 공개 업로드와 지연 임베드
- 한국 대상 MVP의 최소 수집 GA4 즉시 로드
- 개인정보 처리방침과 분석 거부 수단의 공개
