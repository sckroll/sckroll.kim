...
- [x] 미결정 항목별 추천안과 근거 정리
- [x] `Project`, `Post`, `SiteProfile` 도메인 계약 초안 작성
- [x] Notion 속성과 도메인 필드의 매핑표 작성
- [x] 더미 fixture의 정상·경계·비공개 사례 정의
- [x] 실제 콘텐츠 교체 절차 정의
- [x] 사용자 결정의 컨텍스트 문서 반영

## 완료 조건

- [x] 제품 기본값 전부 확정
- [x] 인프라·콘텐츠 기본안 전부 확정
- [x] 개발 도구의 도입·보류 상태 확정
- [x] 더미 콘텐츠 수량과 데이터 계약 승인
- [ ] PROJECTS 재검수 이후 Notion 후속 스키마의 최종 승인
- [x] Phase 02 디자인 시스템 착수 승인
